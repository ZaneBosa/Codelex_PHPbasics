...
{
    exit("You guessed it!  What are the odds?!?");
}
elseif ($guess > $targetNumber)
{
    $guess = readline("Sorry, you are too high.  I was thinking of {$targetNumber}");
    exit();
}
else
{
    $guess = readline("Sorry, you are too low.  I was thinking of {$targetNumber}");
    exit();
}
